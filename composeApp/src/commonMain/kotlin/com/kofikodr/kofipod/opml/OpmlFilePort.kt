 ...
 * into commonMain. Mirrors the [com.kofikodr.kofipod.ui.screens.settings.UpdateActionPort] shape.
 *
 * Android binds this to the flow-driven [com.kofikodr.kofipod.opml.AndroidOpmlFilePort], which is
 * paired with a Compose host (`OpmlPickerHost`) hoisted in [com.kofikodr.kofipod.ui.shell.AppShell]
