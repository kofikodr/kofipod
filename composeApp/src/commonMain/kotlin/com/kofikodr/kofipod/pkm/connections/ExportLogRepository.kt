 ...
 * [com.kofikodr.kofipod.pkm.PkmExportCoordinator] can be unit-tested without a mocking
 ...
 */
class ExportLogRepositoryImpl(db: com.kofikodr.kofipod.db.KofipodDatabase) : ExportLogRepository {
     ...
     */
    private fun toDomain(row: com.kofikodr.kofipod.db.ExportLog): ExportLogEntry? {
