 ...
 * Android types into commonMain. Mirrors [app.kofipod.opml.OpmlFilePort]'s shape.
 *
 * Android binds this to the flow-driven [app.kofipod.backup.AndroidBackupFilePort],
 * which is paired with a Compose host (`BackupPickerHost`) hoisted in
 * [app.kofipod.ui.shell.AppShell] so the SAF launchers stay rooted regardless of which
